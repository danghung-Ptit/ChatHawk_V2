...
HELP_MESSAGE = """You can use the following commands to make the most out of your conversations with me:

🔀 <b>/mode:</b> Choose a different chat mode to customize your experience.

🆕 <b>/new:</b> Use this command to start a new conversation with me anytime you want.

🔄 <b>/retry:</b> If you don't like my previous answer, use this command to get a new one.

❓ <b>/help:</b> If you need assistance or have questions about my commands, just use this command.

Don't hesitate to ask me anything, I'm here to help! 💬
"""
...
async def start_handle(update: Update, context: CallbackContext):
    ...
    reply_text = "👋 Hi, I'm <b>ChatHawk Bot</b> - an artificial intelligence developed and fine-tuned from OpenAI API 🤖 by <b>HungDang</b>. I'm equipped with natural language processing, which allows me to communicate with you in both English and Vietnamese. I have the ability to quickly and accurately answer questions, and I'm ready to assist you in various communication situations.\n\n"
